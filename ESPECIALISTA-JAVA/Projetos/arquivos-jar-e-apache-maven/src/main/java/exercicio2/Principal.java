...
import exercicio1.com.algaworks.crm.api.CadastroCliente;
import exercicio1.com.algaworks.crm.api.Cliente;
...
public class Principal {
    public static void main(String[] args) {
        ...
        for (Cliente cliente : clientes) {
            System.out.printf("%s - %d%n", StringUtils.abbreviate(cliente.getNome(), 10), cliente.getIdade());
        }
    }
}
