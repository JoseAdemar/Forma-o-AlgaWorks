...
public class ServicoDeCobranca {
    ...
    void pagar(Fatura fatura, String emailCobranca, String... emailsAdicionais){
        ...
        Objects.requireNonNull(emailCobranca, "Informe o e-mail adicional");

        System.out.printf("Fatura %d, no valor total ce R$%.2f, foi paga!%n", fatura.numero, fatura.valorTotal);
