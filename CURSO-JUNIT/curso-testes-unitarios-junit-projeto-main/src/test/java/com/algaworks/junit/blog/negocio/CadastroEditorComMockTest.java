...
public class CadastroEditorComMockTest {
    ...
    class CadastroComEditorValido {
        ...
        @Spy
        Editor editor = CadastroEditorComMockMotherTest.umEditorNovo().build();
        ...
        void Dado_um_editor_com_email_existente_Quando_cadastrar_Entao_deve_lancar_exception() {
            ...
            Editor editorComEmailExistente = CadastroEditorComMockMotherTest.umEditorNovo().build();
            cadastroEditor.criar(editor);
    ...
    class EdicaoComEditorValido {
        @Spy
        Editor editor = CadastroEditorComMockMotherTest.umEditorExistente().build();
        ...
        void dado_um_editor_valido_Quando_editar_Entao_deve_alterar_editor_salvo() {
            Editor editorAtualizado = CadastroEditorComMockMotherTest.umEditorExistente()
                    .comEmail("alex.silva@email.com")
                    .comNome("Alex Silva").build();
    ...
    class EdicaoComEditorInexistente {
        ...
        Editor editor = CadastroEditorComMockMotherTest.umEditorComIdInexistente().build();
